...
public class ChatModifier {
    ...
    public void onHoverShowText(IChatBaseComponent text) {
        Preconditions.checkNotNull(text, "text");
        hoverEvent = new ChatHoverable(ChatHoverable.EnumHoverAction.SHOW_TEXT, text);
    }
    ...
    public void onHoverShowItem(String serializedItem) {
        ...
        hoverEvent = new ChatHoverable(ChatHoverable.EnumHoverAction.SHOW_ITEM, new IChatBaseComponent(serializedItem));
    }
    ...
    public void onHoverShowEntity(String type, UUID id, String name) {
        ...
        hoverEvent = new ChatHoverable(ChatHoverable.EnumHoverAction.SHOW_ENTITY, new ChatComponentEntity(type, id, name));
    }
